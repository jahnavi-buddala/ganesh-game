# Vighnaharta Run - Contest Submission Checklist

## Ready

- **Game title:** Vighnaharta Run
...
- **Student IDs:**
- **Campus:**
- **Team lead and contact details:**
- **Demo video link:**
- **Asset permission records:** creator/source and license or generation proof for each supplied GLB, FBX, texture, image, and audio file

## 1-3 minute demo recording plan

1. **0:00-0:15 - Introduction:** show the title screen and say the goal: guide Mushika through the Ganesh Chaturthi street toward Lord Ganesha.
